...
export class SentenceController {
  ...
  async start(
    ...
    return this.scenarioService.start(user, LearningType.SENTENCE_BUILDING, dto);
  }
  ...
  async submit(
    ...
    return this.scenarioService.submit(user, LearningType.SENTENCE_BUILDING, sessionId, dto);
  }
  ...
  async end(
    ...
    return this.scenarioService.end(user, LearningType.SENTENCE_BUILDING, sessionId);
  }
  ...
  async progress(
    ...
    return this.scenarioService.progress(user, LearningType.SENTENCE_BUILDING, childId);
  }
}
