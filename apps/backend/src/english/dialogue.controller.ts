...
export class DialogueController {
  ...
  async start(
    ...
    return this.scenarioService.start(user, LearningType.ORAL_DIALOGUE, dto);
  }
  ...
  async submit(
    ...
    return this.scenarioService.submit(user, LearningType.ORAL_DIALOGUE, sessionId, dto);
  }
  ...
  async end(
    ...
    return this.scenarioService.end(user, LearningType.ORAL_DIALOGUE, sessionId);
  }
  ...
  async progress(
    ...
    return this.scenarioService.progress(user, LearningType.ORAL_DIALOGUE, childId);
  }
}
