...
This project is indexed by GitNexus as **meglow** (968 symbols, 1977 relationships, 67 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/meglow/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/meglow/context` | Codebase overview, check index freshness |
| `gitnexus://repo/meglow/clusters` | All functional areas |
| `gitnexus://repo/meglow/processes` | All execution flows |
| `gitnexus://repo/meglow/process/{name}` | Step-by-step execution trace |
